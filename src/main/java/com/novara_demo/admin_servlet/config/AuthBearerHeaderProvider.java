...
import com.novara_demo.admin_servlet.model.LoginRequest;
import com.novara_demo.admin_servlet.model.RefreshRequest;
import com.novara_demo.admin_servlet.model.TokenResponse;
...
public class AuthBearerHeaderProvider {
    ...
    private long loginCoolOffSeconds;
    ...
    private void attemptLogin() {
        ...
        try {
            ...
            coolOffPeriod.set(Instant.now().plusSeconds(loginCoolOffSeconds));
        }
    }
